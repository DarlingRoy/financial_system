...
public class OrderCommentController {
    ...
    public OrderComment selectOne(@ApiParam(value = " ID") Integer id) {
        return this.orderCommentService.queryById(id);
    }
    ...
    public List<OrderComment> selectAllByLimit(@ApiParam(value = "查询起始位置") int offset,@ApiParam(value = "查询记录条数") int limit) {
        return this.orderCommentService.queryAllByLimit(offset, limit);
    }
    ...
    public List<OrderComment> selectAll() {
        return this.orderCommentService.queryAll();
    }
