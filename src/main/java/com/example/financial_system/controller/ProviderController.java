...
public class ProviderController {
    ...
    public Provider selectOne(@ApiParam(value = " ID") Integer id) {
    ...
    public void insertSelective(Provider provider){
    ...
    public List<Provider> selectAllByLimit(@ApiParam(value = "查询起始位置") int offset,@ApiParam(value = "查询记录条数") int limit) {
        return this.providerService.queryAllByLimit(offset, limit);
    }
    ...
    public List<Provider> selectAll() {
        return this.providerService.queryAll();
    }
